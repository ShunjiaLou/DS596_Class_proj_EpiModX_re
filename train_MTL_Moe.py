...
def main(args):
    ...
    model_name = "LLM_Moe"   # full model — requires CUDA + mamba_ssm (use on SCC/GPU)
    # model_name = "CNN_Moe" # CPU-only fallback for M1 Mac (no mamba_ssm)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-t", "--histone", type=str, default="H3K4me3",
                        choices=["H3K27ac", "H3K4me3", "H3K27me3"],
                        help="Histone mark to train on")
